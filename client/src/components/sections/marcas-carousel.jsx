...
const MarcasCarousel = ({ className }) => {
    ...
    return (
        ...
        >
            ...
            >
                {
                    allMarcas.map((marca, index) => (
                        <div
                            ...
                            className="flex-shrink-0 w-[180px] px-4 transform transition-all duration-500 hover:scale-110 hover:shadow-[0px_4px_14px_#f2ebfc]"
                        >
                            <div className="h-20 bg-[#f9f5ff] rounded-xl shadow-sm p-3 flex items-center justify-center border border-gray-100">
                                <img
            ...
            <div className="absolute left-0 top-0 bottom-0 w-16 bg-gradient-to-r from-[#f9f5ff] to-transparent z-10"></div>
            <div className="absolute right-0 top-0 bottom-0 w-16 bg-gradient-to-l from-[#f9f5ff] to-transparent z-10"></div>
        </div>
    )
};
