                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <Card className="group rounded-xl shadow-md overflow-hidden transform transition-all duration-500 hover:translate-y-[-8px] hover:shadow-lg hover:scale-[1.02] hover:border-primary border-transparent border">
                        <CardContent className="flex flex-col items-center space-y-4 p-6">
                            <Clock aria-label="Construcción Rápida" className="h-12 w-12 text-primary transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:bg-primary/10 rounded-full p-2" />
                    ...
                    <Card className="group rounded-xl shadow-md overflow-hidden transform transition-all duration-500 hover:translate-y-[-8px] hover:shadow-lg hover:scale-[1.02] hover:border-primary border-transparent border">
                        <CardContent className="flex flex-col items-center space-y-4 p-6">
                            <Shield aria-label="Alta Calidad" className="h-12 w-12 text-primary transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:bg-primary/10 rounded-full p-2" />
                    ...
                    <Card className="group rounded-xl shadow-md overflow-hidden transform transition-all duration-500 hover:translate-y-[-8px] hover:shadow-lg hover:scale-[1.02] hover:border-primary border-transparent border">
                        <CardContent className="flex flex-col items-center space-y-4 p-6">
                            <CheckCircle aria-label="Personalización" className="h-12 w-12 text-primary transition-transform duration-500 group-hover:rotate-6 group-hover:scale-110 group-hover:bg-primary/10 rounded-full p-2" />
