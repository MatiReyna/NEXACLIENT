...
const BentoGridItem = ({ className, title, description, header, icon, children, rowSpan = 1, colSpan = 1, ...props }) => {
    return (
        <div className={ cn(
            "row-span-1 rounded-3xl group/bento overflow-hidden border border-border bg-white shadow-md transition-all duration-300 hover:shadow-lg hover:-translate-y-1",
