...
const AdminDashboard = () => {
    ...
    return (
        ...
        //         <div className="col-span-4 md:col-span-2 row-span-3 md:col-start-3 md:row-start-9 bg-white border rounded-xl p-6 shadow hover:shadow-lg transition-all space-y-4">
        //             <h2 className="text-xl font-semibold text-[#592e83] mb-2">Equipo de NEXA</h2>
        //             <p className="text-sm textmuted-foreground mb-4">
        //                 Gestioná los integrantes que se muestran en la página principal.
        //             </p>
      ...
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        <section className="grid grid-cols-4 grid-rows-10 gap-3">
          ...
          {/* div4 - Modelos actuales */}
          <div className="col-span-4 row-span-3 row-start-5 bg-white border rounded-xl p-6 shadow hover:shadow-lg transition-all space-y-4">
            <h2 className="text-xl font-semibold text-[#592e83] mb-4">Modelos actuales</h2>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {[
                {
                  id: 1,
                ...
                <div key={modelo.id} className="rounded-lg border bg-white shadow-sm overflow-hidden">
                  <img src={modelo.imagen} alt={modelo.nombre} className="w-full h-36 object-cover" />
                  <div className="p-3 space-y-1">
                    <h3 className="text-base font-semibold">{modelo.nombre}</h3>
                    <p className="text-sm text-muted-foreground">
          ...
          {/* div6 - Equipo NEXA */}
          <div className="col-span-1 row-span-3 col-start-2 row-start-8 bg-white border rounded-xl p-6 shadow hover:shadow-lg transition-all space-y-4">
            <h2 className="text-xl font-semibold text-[#592e83] mb-2">Equipo de NEXA</h2>
            <p className="text-sm text-muted-foreground mb-4">
              Gestioná los integrantes que se muestran en la página principal.
            </p>
          ...
          {/* div7 - Valoraciones */}
          <div className="col-span-1 row-span-3 col-start-1 row-start-8 bg-white border rounded-xl p-6 shadow hover:shadow-lg transition-all space-y-4">
            <h2 className="text-xl font-semibold text-[#592e83] mb-2">Valoración de la página</h2>
            <p className="text-sm text-muted-foreground">
              Promedio basado en testimonios de usuarios.
            </p>
            {(() => {
              const puntaje = 4.2;
              const color = puntaje >= 4 ? 'bg-green-500' : puntaje >= 3 ? 'bg-yellow-400' : 'bg-red-500';
              return (
                <div className="space-y-2 mt-4">
                  <div className="flex items-center justify-between">
                    <span className="text-lg font-semibold">{puntaje.toFixed(1)} / 5</span>
                    <span className="text-sm text-muted-foreground">35 opiniones</span>
                  </div>
                  <div className="w-full h-3 bg-muted rounded-full overflow-hidden">
                    <div className={`h-full ${color} transition-all`} style={{ width: `${(puntaje / 5) * 100}%` }} />
                  </div>
                </div>
              );
            })()}
